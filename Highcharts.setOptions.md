## Highcharts.setOptions
   * [global](<setOptions.global.md>)
	...
	global选项和lang选项一样并不一定适合每一张图, 必须使用 Highcharts.setOptions 函数才能使其生效。
	例如：
	Highcharts.setOptions({
		global: {
			useUTC: false
	...
	**useUTC**: Boolean
	...
	试一试: [默认值为true](<http://jsfiddle.net/gh/get/jquery/1.7.2/highslide-software/highcharts.com/tree/master/samples/highcharts/global/useutc-true/>) - 起始点为 00:00 UTC，在坐标轴(axis)和消息提示(tooltip)时将会显示 00：00
